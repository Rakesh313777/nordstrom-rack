...
// var whiteProductsObj = JSON.parse(localStorage.getItem("whiteProducts")) || null;
...
function displayData(data) {
    ...
    document.getElementById("eleventhDiv").innerHTML = null;
    ...
    data.forEach(function (el) {
        ...
        document.getElementById("eleventhDiv").append(div);
